    ...
    <div className="">
      ...
      <main className="max-w-7xl mx-auto px-8 sm:px-16">
        ...
        <section className="py-5 mb-5">
          <h2 className="text-4xl font-semibold pb-5 w-auto"> Live Anywhere </h2>
          <div className="flex space-x-3 overflow-scroll scrollbar-hide p-3">
            {liveAnywhereData && liveAnywhereData?.map((item, index) => (
              <MediumCard key={index} liveAnywhereData={item} />
            ))}
          </div>
        </section>
